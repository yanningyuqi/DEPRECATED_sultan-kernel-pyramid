...
//mid thermal limit
#define DEF_ALLOWED_MID_HIGH 78
#define DEF_ALLOWED_MID_FREQ 648000

//low thermal limit
#define DEF_ALLOWED_LOW_HIGH 75
...
int pre_throttled_max = 1566000;
module_param(pre_throttled_max, int, 0664);
EXPORT_SYMBOL(pre_throttled_max);
...
static void check_temp(struct work_struct *work)
{
	...
	for_each_possible_cpu(cpu) {
		...
		//low clr point
			   ...
			   (thermal_throttled > 0)) {
			if (cpu_policy->max < pre_throttled_max) {
