...
#ifdef CONFIG_PYRAMID_MORE_RAM
#define MSM_PMEM_ADSP_BASE	(USER_SMI_BASE + USER_SMI_SIZE + 0x100000)
#else
...
#define USER_SMI_SIZE         ((MSM_SMI_SIZE - KERNEL_SMI_SIZE) - 0x200000)
...
#elif defined(CONFIG_PYRAMID_MORE_RAM)
